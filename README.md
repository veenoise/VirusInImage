...
This repository is for my activity in our Elective: Cybersecurity. The goal of this activity is to hide code inside an image using different tools and methods.
